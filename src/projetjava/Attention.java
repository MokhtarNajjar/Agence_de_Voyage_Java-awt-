 ...
 * @author Mokh
 */
public class Attention extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        String msg="Inserer un valide numero CIN";
        label1.setText(msg);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Attention.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
